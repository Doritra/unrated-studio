    ...
    <>
      <style>{`
        ...
        .maps-hnl-banner {
          ...
          border: 0.5px solid #2a2a2a; padding: 28px 32px;
          margin-bottom: 48px;
          transition: background 0.2s;
        }
        .maps-hnl-banner:hover { background: rgba(245,243,238,0.02); }
        .maps-hnl-label {
        ...
        .maps-hnl-name {
          ...
          font-size: 48px; letter-spacing: 0.04em; color: #F5F3EE; line-height: 1;
        }
        .maps-hnl-link {
        ...
        .maps-hnl-link:hover { opacity: 0.85; }
        ...
        .map-num { font-size: 11px; color: #555; letter-spacing: 0.1em; padding-top: 4px; }
        .map-name {
          font-family: 'Bebas Neue', sans-serif;
        ...
        .map-desc {
          font-size: 13px; font-weight: 300; color: #aaa; line-height: 1.7; max-width: 480px;
        }
        .map-status {
          font-size: 10px; letter-spacing: 0.18em; text-transform: uppercase;
          padding: 6px 14px; border: 0.5px solid; align-self: start; white-space: nowrap;
        }
        ...
        @media (max-width: 768px) {
          ...
          .maps-hnl-banner { flex-direction: column; align-items: flex-start; padding: 20px; }
        }
      `}</style>
      <section className="maps-section" id="maps">
        ...
        <a href="/maps/high-and-low" className="maps-hnl-banner">
          <div>
            <div className="maps-hnl-label">Featured Map — Club Party</div>
            <div className="maps-hnl-name">High And Low</div>
          </div>
          <span className="maps-hnl-link">Lihat Halaman →</span>
        </a>
        ...
        <div className="maps-list">
          {maps.map((m, i) => (
            <div className="map-row" key={m.id}>
              ...
              {m.link ? (
                <a className="map-link" href={m.link} target="_blank" rel="noopener noreferrer">View ↗</a>
              ) : (
